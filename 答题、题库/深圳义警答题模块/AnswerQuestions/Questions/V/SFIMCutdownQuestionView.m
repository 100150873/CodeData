...
@interface SFIMCutdownQuestionView ()
...
@implementation SFIMCutdownQuestionView
...
- (void)submitBtnAction:(UIButton *)btn {
    ...
    if (self.SFIMCutdownQuestionViewSubmitBlock) {
        self.SFIMCutdownQuestionViewSubmitBlock();
    }
}
...
- (UIButton *)submitBtn {
    ...
    if (!_submitBtn) {
        ...
        _submitBtn = [UIButton initButtonTitleFont:_suitFont titleColor:[UIColor hex:@"121212"] backgroundColor:nil image:SFIM_COLLABORATION_RESOURCES_IMAGE(@"study_test_a") titleName:@"交卷"];
...
- (UIButton *)timeBtn {
    ...
    if (!_timeBtn) {
        _timeBtn = [UIButton initButtonTitleFont:_suitFont titleColor:[UIColor hex:@"3f8bf3"] backgroundColor:nil image:SFIM_COLLABORATION_RESOURCES_IMAGE(@"study_test_b") titleName:@"00:00"];
...
- (UIButton *)countBtn {
    ...
    if (!_countBtn) {
        _countBtn = [UIButton initButtonTitleFont:_suitFont titleColor:[UIColor hex:@"262626"] backgroundColor:nil image:SFIM_COLLABORATION_RESOURCES_IMAGE(@"study_test_c") titleName:@"0/0"];
