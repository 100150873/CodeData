...
//    self.titleLabel.frame = CGRectMake(SW_EdgeMargin, SW_EdgeMargin, SW_TitleWidth, SW_TitleHeight);
    ...
    CGFloat y = (newHeight - [SWFormInputCell textViewHeightWithItem:self.item]) / 2;
    self.expandableTextView.frame = CGRectMake(SW_TitleWidth + 2*SW_EdgeMargin, y, SW_SCRREN_WIDTH - (SW_TitleWidth + 3*SW_EdgeMargin), newHeight );
}
