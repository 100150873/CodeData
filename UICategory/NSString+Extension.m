...
- (CGSize)getNSStringSizeWithLimitSize:(CGSize)limitSize fontSize:(UIFont *)font
{

  return  [self boundingRectWithSize:limitSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil].size;
}
